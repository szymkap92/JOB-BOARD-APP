...
<body class="bg-gray-100">
    <div class="container mx-auto py-10 px-4 max-w-4xl">
        <a href="{{ route('home') }}" class="text-blue-600 hover:underline mb-6 inline-block">&larr; Powrót do listy
            ofert</a>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="mt-10 p-6 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <button class="mt-4 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Aplikuj
                    teraz</button>
            </div>
        </div>
    </div>
